import"./main-DtJ3hseT.js";import{C as h}from"./convertapi-DZtGDAzA.js";document.addEventListener("DOMContentLoaded",()=>{const i=document.getElementById("dropZone"),u=document.getElementById("file-input"),d=document.getElementById("uploadContent");let t=[];i.addEventListener("dragover",e=>{e.preventDefault(),i.classList.add("drag-over")}),i.addEventListener("dragleave",()=>{i.classList.remove("drag-over")}),i.addEventListener("drop",e=>{e.preventDefault(),i.classList.remove("drag-over");const o=Array.from(e.dataTransfer.files).filter(a=>a.type==="image/jpeg"||a.type==="image/jpg");o.length>0?c(o):alert("Please select JPG files only.")}),u.addEventListener("change",()=>{const e=Array.from(u.files);e.length>0&&c(e)});function c(e){t=[...t,...e],r()}function r(){const e=t.map((a,s)=>`
          ...
          <div class="files-header">
            ...
            <div class="file-actions-global">
              ...
              <label class="add-more-button">
                ...
                <input type="file" accept=".jpg,.jpeg" multiple hidden onchange="addMoreFiles(event)">
              </label>
            </div>
          </div>
          <div class="file-list">
    ...
    `;try{const n=h.auth("secret_ZbnqhsnKiovC8wpV"),l=n.createParams();if(l.add("File",e[0]),e.length>1)for(let p=1;p<e.length;p++)l.add("Files",e[p]);l.add("PageSize",o),l.add("PageOrientation",a),l.add("ImageQuality",s),l.add("StoreFile",!0),document.querySelector(".progress").style.width="50%",document.querySelector(".progress-text").textContent="Converting to PDF...";const v=await n.convert("jpg","pdf",l);d.innerHTML=`
