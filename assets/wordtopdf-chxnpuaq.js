import"./main-DtJ3hseT.js";import{C as p}from"./convertapi-DZtGDAzA.js";document.addEventListener("DOMContentLoaded",()=>{const n=document.getElementById("dropZone"),r=document.getElementById("file-input"),a=document.getElementById("uploadContent");n.addEventListener("dragover",e=>{e.preventDefault(),n.classList.add("drag-over")}),n.addEventListener("dragleave",()=>{n.classList.remove("drag-over")}),n.addEventListener("drop",e=>{e.preventDefault(),n.classList.remove("drag-over");const t=e.dataTransfer.files[0];t&&(t.name.toLowerCase().endsWith(".doc")||t.name.toLowerCase().endsWith(".docx"))?l(t):alert("Please select a Word document (DOC or DOCX file).")}),r.addEventListener("change",()=>{const e=r.files[0];e&&l(e)});function l(e){a.innerHTML=`
      <div class="conversion-options-wrapper">
        <div class="selected-file">
          <i class="fas fa-file-word"></i> ${e.name} (${c(e.size)})
        </div>
    ...
    `;try{const o=p.auth("secret_ZbnqhsnKiovC8wpV"),s=o.createParams();s.add("File",e),s.add("StoreFile",!0),s.add("PageSize",t),s.add("MarginType",i),document.querySelector(".progress").style.width="50%",document.querySelector(".progress-text").textContent="Converting to PDF...";const v=await o.convert("doc","pdf",s);a.innerHTML=`
